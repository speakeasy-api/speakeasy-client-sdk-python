...
with Speakeasy(
    ...
    res = speakeasy.workspaces.create(request={
        "created_at": parse_datetime("2024-11-17T13:41:10.525Z"),
        "id": "<id>",
        "name": "<value>",
        "organization_id": "<id>",
        "slug": "<value>",
        "updated_at": parse_datetime("2025-11-21T08:36:32.740Z"),
        "verified": True,
    })
...
with Speakeasy(
    ...
    res = speakeasy.workspaces.create_token(request={
        "workspace_token": {
            "alg": "<value>",
            "created_at": parse_datetime("2025-10-04T10:23:04.522Z"),
            "id": "<id>",
            "key": "<key>",
            "name": "<value>",
            "workspace_id": "<id>",
...
with Speakeasy(
    ...
    res = speakeasy.workspaces.update(request={
        "workspace": {
            "created_at": parse_datetime("2024-08-01T22:30:24.264Z"),
            "id": "<id>",
            "name": "<value>",
            "organization_id": "<id>",
            "slug": "<value>",
            "updated_at": parse_datetime("2026-01-24T03:53:13.581Z"),
            "verified": True,
        },
    })
...
with Speakeasy(
    ...
    res = speakeasy.workspaces.update_settings(request={
        "workspace_settings": {
            "created_at": parse_datetime("2026-03-09T15:48:09.330Z"),
            "updated_at": parse_datetime("2026-11-24T16:37:53.492Z"),
