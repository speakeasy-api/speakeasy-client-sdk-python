...
<!-- UsageSnippet language="python" operationID="generateCodeSamplePreview" method="post" path="/v1/code_sample/preview" example="default" -->
```python
...
<!-- UsageSnippet language="python" operationID="generateCodeSamplePreviewAsync" method="post" path="/v1/code_sample/preview/async" -->
```python
from speakeasy_client_sdk_python import Speakeasy
from speakeasy_client_sdk_python.models import shared
...
<!-- UsageSnippet language="python" operationID="getCodeSamples" method="get" path="/v1/code_sample" example="default" -->
```python
from speakeasy_client_sdk_python import Speakeasy
from speakeasy_client_sdk_python.models import shared
...
<!-- UsageSnippet language="python" operationID="getCodeSamplePreviewAsync" method="get" path="/v1/code_sample/preview/async/{jobID}" example="default" -->
```python
from speakeasy_client_sdk_python import Speakeasy
from speakeasy_client_sdk_python.models import shared
