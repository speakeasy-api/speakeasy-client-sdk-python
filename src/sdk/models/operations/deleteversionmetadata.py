...
@dataclass
class DeleteVersionMetadataPathParams:api_id: str = field(default=None, metadata={'path_param': { 'field_name': 'apiID', 'style': 'simple', 'explode': False }})
...
@dataclass
class DeleteVersionMetadataRequest:path_params: DeleteVersionMetadataPathParams = field(default=None)
    

@dataclass
class DeleteVersionMetadataResponse:content_type: str = field(default=None)
