...
class CodeSamples(BaseSDK):
        ...
        *,
        ...
        if utils.match_response(http_res, "2XX", "application/json"):
            return operations.GenerateCodeSamplePreviewResponse(
                usage_snippets=unmarshal_json_response(
                    Optional[shared.UsageSnippets], http_res
                ),
    ...
    def generate_code_sample_preview_asynchronous(
        self,
        *,
        request: Union[
            shared.CodeSampleSchemaInput, shared.CodeSampleSchemaInputTypedDict
    ...
    def get_code_sample_preview_async(
        self,
        *,
        request: Union[
        ...
        if utils.match_response(http_res, "202", "application/json"):
            return operations.GetCodeSamplePreviewAsyncResponse(
                object=unmarshal_json_response(
                    Optional[operations.GetCodeSamplePreviewAsyncResponseBody], http_res
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
